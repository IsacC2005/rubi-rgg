...
public class ButtonGradient extends JButton {
    ...
    private Timer timerLimit;
    private float alpha = 0.3f;
    private boolean mouseOver;
    private boolean pressed;
    private boolean animacionAct = true;
    private Point pressedLocation;
    private float pressedSize;
    private float sizeSpeed = 1f;
    private float alphaPressed = 0.5f;

    public boolean isAnimacionAct() {
        return animacionAct;
    }

    public void setAnimacionAct(boolean animacionAct) {
        this.animacionAct = animacionAct;
    }
    ...
    public ButtonGradient() {
        ...
        timerPressed = new Timer(0, new ActionListener() {
            ...
            public void actionPerformed(ActionEvent ae) {                
                i++;
                System.out.println("Se a imprimido "+ i);
                pressedSize += getSizeSpeed();
               // System.out.println("este es el valor final que debe de tener el pressedSize "+ pressedSize);
                if (alphaPressed <= 0) {
                    pressed = false;
                    timerPressed.stop();
                } else {
